! function(e) {
	...
	function t(t) {
		...
		const e = {
			MILLICAST_STREAM_NAME: "kql9tbmi",
			MILLICAST_ACCOUNT_ID: "tWBXmA",
	...
	var r, n = (function(e) {
		var t = function(e) {
			...
			function k(e, r) {
				...
				var s = i.arg;
				return s ? s.done ? (r[e.resultName] = s.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, m) : s : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, m)
			}
			...
			return v.prototype = C.constructor = y, y.constructor = v, v.displayName = c(y, a, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
	...
	var C = S((function(e) {
		! function(t) {
			...
			var i = {},
				...
				o = function() {
					...
					for (t = 1; t < r.length; t++)
						for (e in r[t]) !(e in n) && r[t].hasOwnProperty(e) && (n[e] = r[t][e]);
					return n
				},
				a = function(e, t) {
					return {
			...
			(u = n).enabledFor = s(d, d.enabledFor), u.trace = s(d, d.trace), u.debug = s(d, d.debug), u.time = s(d, d.time), u.timeEnd = s(d, d.timeEnd), u.info = s(d, d.info), u.warn = s(d, d.warn), u.error = s(d, d.error), u.log = u.info, n.setHandler = function(e) {
				r = e
				...
				return "undefined" == typeof console ? function() {} : function(i, s) {
					i = Array.prototype.slice.call(i);
					var o, a = console.log;
					s.level === n.TIME ? (o = (s.name ? "[" + s.name + "] " : "") + i[0], "start" === i[1] ? console.time ? console.time(o) : t[o] = (new Date).getTime() : console.timeEnd ? console.timeEnd(o) : r(a, [o + ": " + ((new Date).getTime() - t[o]) + "ms"])) : (s.level === n.WARN && console.warn ? a = console.warn : s.level === n.ERROR && console.error ? a = console.error : s.level === n.INFO && console.info ? a = console.info : s.level === n.DEBUG && console.debug ? a = console.debug : s.level === n.TRACE && console.trace && (a = console.trace), e.formatter(i, s), r(a, i))
				}
	...
	C.useDefaults({
		defaultLevel: C.TRACE
	});
	const E = (e, t) => {
			e.unshift(`[${t.name||"Global"}] ${(new Date).toISOString()} - ${t.level.name} -`)
		},
		x = (e, t) => t ? e.value >= A[t].value : e.value >= R.value,
		k = C.createDefaultHandler({
			formatter: E
		});
	C.setHandler(((e, t) => {
		((e, t) => {
			e = (e = Array.prototype.slice.call(e)).map((e => "object" == typeof e ? JSON.stringify(e) : e)), E(e, t), 0 !== I ? (T.push(e.join(" ")), T.length >= I && (T = T.slice(-I))) : T = []
		})(e, t), x(t.level, t.name) && k(e, t);
		var r, n = w(P);
		try {
			for (n.s(); !(r = n.n()).done;) {
				const n = r.value,
	...
	var G = q,
		...
		J = F.isStandardBrowserEnv() ? {
			write: function(e, t, r, n, i, s) {
				var o = [];
				o.push(e + "=" + encodeURIComponent(t)), F.isNumber(r) && o.push("expires=" + new Date(r).toGMTString()), F.isString(n) && o.push("path=" + n), F.isString(i) && o.push("domain=" + i), !0 === s && o.push("secure"), document.cookie = o.join("; ")
			},
			read: function(e) {
		...
		Z = ["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"],
		K = F.isStandardBrowserEnv() ? function() {
		...
		Q = function(e) {
			return new Promise((function(t, r) {
				...
				if (s.open(e.method.toUpperCase(), z(d, e.params, e.paramsSerializer), !0), s.timeout = e.timeout, s.onreadystatechange = function() {
						if (s && 4 === s.readyState && (0 !== s.status || s.responseURL && 0 === s.responseURL.indexOf("file:"))) {
							var n = "getAllResponseHeaders" in s ? function(e) {
									var t, r, n, i = {};
				...
				if ("setRequestHeader" in s && F.forEach(i, (function(e, t) {
						void 0 === n && "content-type" === t.toLowerCase() ? delete i[t] : s.setRequestHeader(t, e)
					})), F.isUndefined(e.withCredentials) || (s.withCredentials = !!e.withCredentials), e.responseType) try {
	...
	var re, ne = {
		...
		transformRequest: [function(e, t) {
			return X(t, "Accept"), X(t, "Content-Type"), F.isFormData(e) || F.isArrayBuffer(e) || F.isBuffer(e) || F.isStream(e) || F.isFile(e) || F.isBlob(e) ? e : F.isArrayBufferView(e) ? e.buffer : F.isURLSearchParams(e) ? (te(t, "application/x-www-form-urlencoded;charset=utf-8"), e.toString()) : F.isObject(e) ? (te(t, "application/json;charset=utf-8"), JSON.stringify(e)) : e
		}],
	...
	var oe = function(e) {
			return se(e), e.headers = e.headers || {}, e.data = H(e.data, e.headers, e.transformRequest), e.headers = F.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers), F.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (function(t) {
				delete e.headers[t]
		...
		ae = function(e, t) {
			...
			})), F.forEach(i, c), F.forEach(s, (function(n) {
	...
	ce.prototype.request = function(e) {
		"string" == typeof e ? (e = arguments[1] || {}).url = arguments[0] : e = e || {}, (e = ae(this.defaults, e)).method ? e.method = e.method.toLowerCase() : this.defaults.method ? e.method = this.defaults.method.toLowerCase() : e.method = "get";
		var t = [oe, void 0],
			r = Promise.resolve(e);
	...
	var me = he(ie);
	me.Axios = ue, me.create = function(e) {
		return he(ae(me.defaults, e))
	}, me.Cancel = le, me.CancelToken = pe, me.isCancel = W, me.all = function(e) {
	...
	var ye, we = ge,
		...
		Se = be && "function" == typeof be.apply ? be.apply : function(e, t, r) {
			return Function.prototype.apply.call(e, t, r)
		};
	ye = be && "function" == typeof be.ownKeys ? be.ownKeys : Object.getOwnPropertySymbols ? function(e) {
		return Object.getOwnPropertyNames(e).concat(Object.getOwnPropertySymbols(e))
	} : function(e) {
		return Object.getOwnPropertyNames(e)
	};
	var Ce = Number.isNaN || function(e) {
		return e != e
	};
	...
	function Ae(e, t, r, n) {
		var i, s, o, a;
		if (Te(r), void 0 === (s = e._events) ? (s = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== s.newListener && (e.emit("newListener", t, r.listener ? r.listener : r), s = e._events), o = s[t]), void 0 === o) o = s[t] = r, ++e._eventsCount;
	...
	Object.defineProperty(Ee, "defaultMaxListeners", {
		...
		return Te(t), this.on(e, Le(this, e, t)), this
	}, Ee.prototype.prependOnceListener = function(e, t) {
		return Te(t), this.prependListener(e, Le(this, e, t)), this
	}, Ee.prototype.removeListener = function(e, t) {
		var r, n, i, s, o;
		if (Te(t), void 0 === (n = this._events)) return this;
		...
		return this
	}, Ee.prototype.off = Ee.prototype.removeListener, Ee.prototype.removeAllListeners = function(e) {
		var t, r, n;
	...
	}, Ee.prototype.listenerCount = Be, Ee.prototype.eventNames = function() {
	...
	class ze extends xe {
		...
		init() {
			var e = this;
			Fe.info("Initializing peer connection stats"), this.emitInterval = setInterval(g((function*() {
	...
	const $e = (e, t, r) => {
		...
		qe = (e, t, r) => {
			...
			const s = Xe(e, n);
			if (s.totalBytesReceived = e.bytesReceived, s.totalPacketsReceived = e.packetsReceived, s.totalPacketsLost = e.packetsLost, s.jitter = e.jitter, s.id = e.id, s.bitrate = 0, s.packetsLostRatioPerSecond = 0, s.packetsLostDeltaPerSecond = 0, t) {
		...
		Ge = (e, t) => {
			Fe.debug("Parsing candidate-pair report"), t.totalRoundTripTime = e.totalRoundTripTime, t.currentRoundTripTime = e.currentRoundTripTime, t.availableOutgoingBitrate = e.availableOutgoingBitrate, t.candidateType = t.raw.get(e.localCandidateId).candidateType
		},
		He = e => e.mediaType || e.kind,
		We = (e, t) => {
			var r;
			return {
				mimeType: (e && null !== (r = t.get(e)) && void 0 !== r ? r : {}).mimeType
			}
		},
		Xe = (e, t) => {
			const r = {};
			...
			write: function(e, t) {
				...
				return r.forEach((function(t) {
					Ze[t].forEach((function(r) {
						r.name in e && null != e[r.name] ? i.push(tt(t, r, e)) : r.push in e && null != e[r.push] && e[r.push].forEach((function(e) {
							i.push(tt(t, r, e))
						}))
					}))
				})), e.media.forEach((function(e) {
					i.push(tt("m", Ze.m[0], e)), n.forEach((function(t) {
						Ze[t].forEach((function(r) {
							r.name in e && null != e[r.name] ? i.push(tt(t, r, e)) : r.push in e && null != e[r.push] && e[r.push].forEach((function(e) {
								i.push(tt(t, r, e))
							}))
	...
	for (var vt = gt, yt = function(e) {
			...
			var t, r, n = Tt(e),
				i = n[0],
				s = n[1],
				o = new Et(function(e, t, r) {
					return 3 * (t + r) / 4 - r
				}(0, i, s)),
				a = 0,
				c = s > 0 ? i - 4 : i;
			for (r = 0; r < c; r += 4) t = Ct[e.charCodeAt(r)] << 18 | Ct[e.charCodeAt(r + 1)] << 12 | Ct[e.charCodeAt(r + 2)] << 6 | Ct[e.charCodeAt(r + 3)], o[a++] = t >> 16 & 255, o[a++] = t >> 8 & 255, o[a++] = 255 & t;
			...
			return i.join("")
		}, St = [], Ct = [], Et = "undefined" != typeof Uint8Array ? Uint8Array : Array, xt = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", kt = 0, It = xt.length; kt < It; ++kt) St[kt] = xt[kt], Ct[xt.charCodeAt(kt)] = kt;
	...
	var At = {
		...
		Lt = function(e, t, r, n, i, s) {
			var o, a, c, u = 8 * s - i - 1,
				...
				h = n ? 1 : -1,
				m = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
			for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, o = d) : (o = Math.floor(Math.log(t) / Math.LN2), t * (c = Math.pow(2, -o)) < 1 && (o--, c *= 2), (t += o + l >= 1 ? f / c : f * Math.pow(2, 1 - l)) * c >= 2 && (o++, c /= 2), o + l >= d ? (a = 0, o = d) : o + l >= 1 ? (a = (t * c - 1) * Math.pow(2, i), o += l) : (a = t * Math.pow(2, l - 1) * Math.pow(2, i), o = 0)); i >= 8; e[r + p] = 255 & a, p += h, a /= 256, i -= 8);
		...
		Ot = S((function(e, t) {
			...
			t.kMaxLength = n, s.TYPED_ARRAY_SUPPORT = function() {
				try {
				...
				if (H(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)), H(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), !s.isBuffer(e) || !s.isBuffer(t)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
				if (e === t) return 0;
				let r = e.length,
					n = t.length;
			...
			}, r && (s.prototype[r] = s.prototype.inspect), s.prototype.compare = function(e, t, r, n, i) {
			...
			j("ERR_BUFFER_OUT_OF_BOUNDS", (function(e) {
				...
				let n = `The value of "${e}" is out of range.`,
					i = r;
				return Number.isInteger(r) && Math.abs(r) > 2 ** 32 ? i = U(String(r)) : "bigint" == typeof r && (i = String(r), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = U(i)), i += "n"), n += ` It must be ${t}. Received ${i}`, n
			}), RangeError);
			...
			function q(e) {
				return At.toByteArray(function(e) {
		...
		Bt = S((function(e, t) {
			...
			r.from && r.alloc && r.allocUnsafe && r.allocUnsafeSlow ? e.exports = Ot : (n(Ot, t), t.Buffer = i), n(r, i), i.from = function(e, t, n) {
		...
		Mt = S((function(e) {
			...
			i && i.getRandomValues ? e.exports = function(e, s) {
				if (e > r) throw new RangeError("requested too many random bytes");
				var o = n.allocUnsafe(e);
				if (e > 0)
					if (e > t)
						for (var a = 0; a < e; a += t) i.getRandomValues(o.slice(a, a + t));
					else i.getRandomValues(o);
				if ("function" == typeof s) return process.nextTick((function() {
					s(null, o)
				}));
				return o
			} : e.exports = function() {
	...
	class _t {
		...
		plain() {
			var e = {
				id: this.id,
				direction: Ut.toString(this.direction)
			};
	...
	class Wt {
		...
		getCodec(e) {
			for (const t of this.codecs.values())
				if (t.getCodec().toLowerCase() === e.toLowerCase()) return t;
			return null
		}
		hasCodec(e) {
	...
	class nr {
		...
		getFirstTrack(e) {
			for (let t of this.tracks.values())
				if (t.getMedia().toLowerCase() === e.toLowerCase()) return t;
			return null
		}
		getTracks() {
			return this.tracks
	...
	class sr {
		...
		replaceMedia(e) {
			for (let t in this.medias)
				if (this.medias[t].getId() == e.getId()) return this.medias[t] = e, !0;
			return !1
		}
		getMedias() {
			return this.medias
		...
		addCandidate(e) {
			for (let t = 0; t < this.candidates.length; ++t)
				if (this.candidates[t].equals(e)) return;
		...
		getTrackByMediaId(e) {
			for (let t of this.streams.values())
				for (let [r, n] of t.getTracks())
					if (n.getMediaId() == e) return n;
			return null
		}
		getStreamByMediaId(e) {
			for (let t of this.streams.values())
				for (let [r, n] of t.getTracks())
					if (n.getMediaId() == e) return t;
			return null
		}
		answer(e) {
			const t = new sr;
			e.ice && (e.ice instanceof Dt ? t.setICE(e.ice.clone()) : t.setICE(Dt.expand(e.ice))), e.dtls && (e.dtls instanceof mt ? t.setDTLS(e.dtls) : t.setDTLS(mt.expand(e.dtls))), e.crypto && (e.crypto instanceof vt ? t.setCrypto(e.crypto) : t.setCrypto(vt.expand(e.crypto)));
		...
		toString() {
			...
			e.version = 0, e.origin = {
				...
				ipVer: 4,
				address: "127.0.0.1"
			}, e.name = "semantic-sdp", e.connection = {
				version: 4,
				ip: "0.0.0.0"
			}, e.timing = {
				start: 0,
				stop: 0
			}, this.hasICE() && this.getICE().isLite() && (e.icelite = "ice-lite"), e.msidSemantic = {
				semantic: "WMS",
				token: "*"
			}, e.groups = [];
			let t = {
			...
			for (let r in this.medias) {
				...
				i.direction = Ht.toString(n.getDirection()), i.rtcpMux = "rtcp-mux", i.rtcpRsize = "rtcp-rsize", i.extmapAllowMixed = "extmap-allow-mixed", i.mid = n.getId(), t.mids.push(n.getId()), n.hasControl() && (i.control = n.getControl()), n.getBitrate() > 0 && i.bandwidth.push({
					type: "AS",
					limit: n.getBitrate()
				});
				...
				this.getICE() && (i.iceUfrag = this.getICE().getUfrag(), i.icePwd = this.getICE().getPwd()), this.getDTLS() ? (i.protocol = "UDP/TLS/RTP/SAVPF", i.fingerprint = {
					type: this.getDTLS().getHash(),
					hash: this.getDTLS().getFingerprint()
				}, i.setup = pt.toString(this.getDTLS().getSetup())) : this.getCrypto() ? (i.protocol = "UDP/SAVPF", i.crypto = [{
					id: this.getCrypto().getTag(),
					suite: this.getCrypto().getSuite(),
					config: this.getCrypto().getKeyParams()
				}]) : i.protocol = "UDP/AVP";
				for (let e of n.getCodecs().values()) {
					"video" === n.getType().toLowerCase() ? i.rtp.push({
						payload: e.getType(),
						codec: e.getCodec().toUpperCase(),
						rate: 9e4
					}) : "opus" === e.getCodec().toLowerCase() || "multiopus" === e.getCodec().toLowerCase() ? i.rtp.push({
						payload: e.getType(),
						codec: e.getCodec(),
						rate: 48e3,
						encoding: e.getChannels()
					}) : i.rtp.push({
						payload: e.getType(),
						codec: e.getCodec(),
						rate: 8e3
					});
					for (const t of e.getRTCPFeedbacks()) i.rtcpFb.push({
						payload: e.getType(),
						type: t.getId(),
						subtype: t.getParams().join(" ")
					});
					e.hasRTX() && (i.rtp.push({
						payload: e.getRTX(),
						codec: "rtx",
				...
				i.payloads = o.join(" ");
				for (let [e, t] of n.getExtensions().entries()) i.ext.push({
					value: e,
					uri: t
				});
				for (let e of n.getRIDs().values()) {
					let t = {
						id: e.getId(),
						direction: Ut.toString(e.getDirection()),
						params: ""
					};
						...
						if (r.getMediaId()) {
							if (r.getMediaId() == i.mid) {
								...
								for (let t in e) {
									let r = e[t];
									i.ssrcGroups.push({
										semantics: r.getSemantics(),
										ssrcs: r.getSSRCs().join(" ")
									})
								}
								let n = r.getSSRCs();
								for (let e in n) i.ssrcs.push({
									id: n[e],
									attribute: "cname",
									value: t.getId()
								}), i.ssrcs.push({
						...
						rgx: function(e, t) {
							for (var r, o, a, c, u, d, l = 0; l < t.length && !u;) {
								...
								for (r = o = 0; r < f.length && !u;)
									if (u = f[r++].exec(e))
										for (a = 0; a < p.length; a++) d = u[++o], typeof(c = p[a]) === s && c.length > 0 ? 2 == c.length ? typeof c[1] == i ? this[c[0]] = c[1].call(this, d) : this[c[0]] = c[1] : 3 == c.length ? typeof c[1] !== i || c[1].exec && c[1].test ? this[c[0]] = d ? d.replace(c[1], c[2]) : n : this[c[0]] = d ? c[1].call(this, d, c[2]) : n : 4 == c.length && (this[c[0]] = d ? c[3].call(this, d.replace(c[1], c[2])) : n) : this[c] = d || n;
								l += 2
							}
						},
						str: function(e, t) {
		...
		static setSimulcast(e, t) {
			...
			try {
				...
				for (let t = 0; t < d; ++t) {
					const r = 100 + 2 * t,
						n = r + 1;
					l.push(r), e += "a=ssrc-group:FID " + r + " " + n + "\r\na=ssrc:" + r + " cname:" + o + "\r\na=ssrc:" + r + " msid:" + c + "\r\na=ssrc:" + r + " mslabel:" + a + "\r\na=ssrc:" + r + " label:" + u + "\r\na=ssrc:" + n + " cname:" + o + "\r\na=ssrc:" + n + " msid:" + c + "\r\na=ssrc:" + n + " mslabel:" + a + "\r\na=ssrc:" + n + " label:" + u + "\r\n"
				}
		...
		static setVideoBitrate(e, t) {
			if (t < 1) dr.info("Remove bitrate restrictions"), e = e.replace(/b=AS:.*\r\n/, "").replace(/b=TIAS:.*\r\n/, "");
				...
				const r = new ur,
					...
					i = n.getMedia("video");
				dr.info("Setting video bitrate"), i.setBitrate(t), (e = n.toString()).indexOf("b=AS:") > -1 && r.isFirefox() && (dr.info("Updating SDP for firefox browser"), e = e.replace("b=AS:", "b=TIAS:"), dr.debug("SDP updated for firefox: ", e))
			}
			return e
		}
		static removeSdpLine(e, t) {
			return dr.debug("SDP before trimming: ", e), e = e.split("\n").filter((e => e.trim() !== t)).join("\n"), dr.debug("SDP trimmed result: ", e), e
		}
	...
	var gr = class extends xe {
		constructor(e) {
			super(), this.maxId = 0, this.namespaces = new Map, this.transactions = new Map, this.transport = e, this.listener = t => {
				let r;
				try {
	...
	class xr extends xe {
		...
		connect() {
			...
			return g((function*() {
				var t;
				return vr.info("Connecting to Signaling Server"), e.transactionManager && (null === (t = e.webSocket) || void 0 === t ? void 0 : t.readyState) === WebSocket.OPEN ? (vr.info("Connected to server: ", e.webSocket.url), vr.debug("WebSocket value: ", {
					url: e.webSocket.url,
					protocol: e.webSocket.protocol,
					readyState: e.webSocket.readyState,
					binaryType: e.webSocket.binaryType,
					extensions: e.webSocket.extensions
				}), e.emit(yr, {
					ws: e.webSocket,
					tm: e.transactionManager
				}), e.webSocket) : new Promise(((t, r) => {
					e.webSocket = new WebSocket(e.wsUrl), e.transactionManager = new gr(e.webSocket), e.webSocket.onopen = () => {
						vr.info("WebSocket opened"), e.transactionManager.on("event", (t => {
							e.emit(Sr, t)
						})), vr.info("Connected to server: ", e.webSocket.url), vr.debug("WebSocket value: ", {
							url: e.webSocket.url,
							protocol: e.webSocket.protocol,
							readyState: e.webSocket.readyState,
							binaryType: e.webSocket.binaryType,
		...
		subscribe(e) {
			...
			return g((function*() {
				...
				const r = {
					sdp: e = pr.adaptCodecName(e, "AV1X", Cr.AV1),
		...
		publish(e, t = Cr.H264, r = null) {
			var n = this;
			return g((function*() {
				vr.info(`Starting publishing to streamName: ${n.streamName}, codec: ${t}`), vr.debug("Publishing local description: ", e);
				const i = Object.values(Cr);
				if (-1 === i.indexOf(t)) throw vr.error("Invalid codec. Possible values are: ", i), new Error(`Invalid codec. Possible values are: ${i}`);
				...
				try {
					var o;
					yield n.connect(), vr.info("Sending publish command");
					const e = yield n.transactionManager.cmd("publish", s);
					return t === Cr.AV1 && (e.sdp = pr.adaptCodecName(e.sdp, Cr.AV1, "AV1X")), -1 !== (null === (o = e.sdp) || void 0 === o ? void 0 : o.indexOf("\na=extmap-allow-mixed")) && (e.sdp = pr.removeSdpLine(e.sdp, "a=extmap-allow-mixed")), vr.info("Command sent, publisherId: ", e.publisherId), vr.debug("Command result: ", e), e.sdp
				} catch (e) {
	...
	class Ar extends xe {
		constructor() {
			super(), this.sessionDescription = null, this.peer = null, this.peerConnectionStats = null
		}
		createRTCPeer(e = null) {
			var t = this;
			return g((function*() {
				kr.info("Creating new RTCPeerConnection"), kr.debug("RTC configuration provided by user: ", e), e = yield t.getRTCConfiguration(e), t.peer = Or(t, e)
			}))()
		}
		getRTCPeer() {
			if (kr.info("Getting RTC Peer"), this.peer) {
				const e = Dr(this.peer),
					t = this.peer,
					r = t.currentLocalDescription,
					n = t.currentRemoteDescription;
				kr.debug("getRTCPeer return: ", {
					connectionState: e,
					currentLocalDescription: r,
					currentRemoteDescription: n
				})
			}
			return this.peer
		}
		closeRTCPeer() {
			...
			return g((function*() {
				var t;
				kr.info("Closing RTCPeerConnection"), null === (t = e.peer) || void 0 === t || t.close(), e.peer = null, e.stopStats(), e.emit(Tr, "closed")
			}))()
		}
		getRTCConfiguration(e) {
			var t = this;
			return g((function*() {
				var r;
				kr.info("Getting RTC configuration");
				const n = null != e ? e : {};
				return n.iceServers = null !== (r = n.iceServers) && void 0 !== r ? r : yield t.getRTCIceServers(), n
			}))()
		}
		...
		getRTCLocalSDP(e = Rr) {
			var t = this;
			return g((function*() {
				kr.info("Getting RTC Local SDP"), e = h(h({}, Rr), e), kr.debug("Options: ", e);
				const r = Lr(e.mediaStream);
				r ? Mr(t.peer, r, e) : Nr(t.peer, e), kr.info("Creating peer offer");
				const n = yield t.peer.createOffer();
				return kr.info("Peer offer created"), kr.debug("Peer offer response: ", n.sdp), t.sessionDescription = n, e.disableAudio || (t.sessionDescription.sdp = pr.setMultiopus(t.sessionDescription.sdp, r), e.stereo && (t.sessionDescription.sdp = pr.setStereo(t.sessionDescription.sdp))), !e.disableVideo && e.simulcast && (t.sessionDescription.sdp = pr.setSimulcast(t.sessionDescription.sdp, e.codec)), yield t.peer.setLocalDescription(t.sessionDescription), kr.info("Peer local description set"), t.sessionDescription.sdp
			}))()
		}
		...
		updateBitrate(e = 0) {
			var t = this;
			return g((function*() {
				if (!t.peer) throw kr.error("Cannot update bitrate. No peer found."), new Error("Cannot update bitrate. No peer found.");
				kr.info("Updating bitrate to value: ", e), t.peer = yield t.getRTCPeer(), yield t.peer.setLocalDescription(t.sessionDescription);
		...
		static getCapabilities(e) {
			const t = new ur;
			if (t.isFirefox()) return (e => "video" === e ? {
				codecs: [{
					codec: "vp8",
					mimeType: "video/VP8"
				}, {
			...
			if (r) {
				...
				"audio" === e && (o = new RegExp(`^audio/(${Object.values(Er).join("|")})$`, "i"), t.isChrome() && (s.multiopus = {
				...
				r.codecs = Object.keys(s).map((e => h({
					codec: e
				}, s[e])))
			}
			return r
		...
		initStats() {
			this.peerConnectionStats ? kr.warn("Cannot init peer stats: Already initialized") : this.peer ? (this.peerConnectionStats = new ze(this.peer), this.peerConnectionStats.init(), De(this.peerConnectionStats, this, [Ve])) : kr.warn("Cannot init peer stats: RTCPeerConnection not initialized")
		}
		stopStats() {
			var e;
	...
	const Pr = e => (null == e ? void 0 : e.getAudioTracks().length) <= 1 && (null == e ? void 0 : e.getVideoTracks().length) <= 1,
		Lr = e => {
			if (!e) return null;
			if (e instanceof MediaStream && Pr(e)) return e;
		...
		Br = (e, t) => {
			t.ontrack = t => {
				kr.info("New track from peer."), kr.debug("Track event value: ", t), e.emit(Ir, t)
			}, t.connectionState ? t.onconnectionstatechange = r => {
				kr.info("Peer connection state change: ", t.connectionState), e.emit(Tr, t.connectionState)
			} : t.oniceconnectionstatechange = r => {
				kr.info("Peer ICE connection state change: ", t.iceConnectionState), e.emit(Tr, t.iceConnectionState)
			}
		},
		Mr = (e, t, r) => {
			kr.info("Adding mediaStream tracks to RTCPeerConnection");
			var n, i = w(t.getTracks());
			try {
				for (i.s(); !(n = i.n()).done;) {
					const i = n.value,
						s = {
					...
					"audio" === i.kind && (s.direction = r.disableAudio ? "inactive" : "sendonly"), "video" === i.kind && (s.direction = r.disableVideo ? "inactive" : "sendonly", r.scalabilityMode && (new ur).isChrome() ? (kr.debug(`Video track with scalability mode: ${r.scalabilityMode}.`), s.sendEncodings = [{
						scalabilityMode: r.scalabilityMode
					}]) : r.scalabilityMode && kr.warn("SVC is only supported in Google Chrome")), e.addTransceiver(i, s), kr.info(`Track '${i.label}' added: `, `id: ${i.id}`, `kind: ${i.kind}`)
				}
			} catch (e) {
				i.e(e)
			} finally {
		...
		Nr = (e, t) => {
			e.addTransceiver("video", {
				direction: t.disableVideo ? "inactive" : "recvonly"
			}), e.addTransceiver("audio", {
				direction: t.disableAudio ? "inactive" : "recvonly"
			})
		},
		Dr = e => {
			var t;
	...
	jr.prototype = new Error, jr.prototype.name = "InvalidCharacterError";
	var Ur = "undefined" != typeof window && window.atob && window.atob.bind(window) || function(e) {
		var t = String(e).replace(/=+$/, "");
		if (t.length % 4 == 1) throw new jr("'atob' failed: The string to be decoded is not correctly encoded.");
		for (var r, n, i = 0, s = 0, o = ""; n = t.charAt(s++); ~n && (r = i % 4 ? 64 * r + n : n, i++ % 4) ? o += String.fromCharCode(255 & r >> (-2 * i & 6)) : 0) n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(n);
		return o
	};
	...
	function _r(e) {
		...
		try {
			return function(e) {
				return decodeURIComponent(Ur(e).replace(/(.)/g, (function(e, t) {
	...
	function Vr(e, t) {
		if ("string" != typeof e) throw new Fr("Invalid token specified");
		var r = !0 === (t = t || {}).header ? 0 : 1;
		try {
			return JSON.parse(_r(e.split(".")[r]))
		} catch (e) {
			throw new Fr("Invalid token specified: " + e.message)
		}
	}
	Fr.prototype = new Error, Fr.prototype.name = "InvalidTokenError";
	const zr = L.get("Director"),
		$r = "WebRtc";
	let qr, Gr = "https://director.millicast.com";
	class Hr {
		...
		static getPublisher(e, t, r = $r) {
			var n = this;
			return g((function*() {
				zr.info("Getting publisher connection path for stream name: ", t);
				const i = {
						streamName: t,
						streamType: r
					},
				...
				try {
					const e = (yield we.post(o, i, {
						headers: s
					})).data;
					return zr.debug("Getting publisher response: ", e), h(h({}, e.data), {}, {
						jwtDecoded: Vr(e.data.jwt).millicast
					})
				} catch (e) {
					var a;
					throw zr.error("Error while getting publisher connection path: ", null === (a = e.response) || void 0 === a ? void 0 : a.data), e
				}
			}))()
		}
		static getSubscriber(e, t, r = null) {
			var n = this;
			return g((function*() {
				zr.info(`Getting subscriber connection data for stream name: ${e} and account id: ${t}`);
				const i = {
					streamAccountId: t,
					streamName: e
				};
				...
				try {
					...
					return zr.debug("Getting subscriber response: ", e), h(h({}, e.data), {}, {
						jwtDecoded: Vr(e.data.jwt).millicast
					})
				} catch (e) {
					var a;
					throw zr.error("Error while getting subscriber connection path: ", null === (a = e.response) || void 0 === a ? void 0 : a.data), e
				}
			}))()
		}
	}
	class Wr extends xe {
		constructor(e, t, r, n) {
			if (super(), qr = r, !e) throw qr.error("Stream Name is required to construct this module."), new Error("Stream Name is required to construct this module.");
			if (!t) throw qr.error("Token generator is required to construct this module."), new Error("Token generator is required to construct this module.");
			this.webRTCPeer = new Ar, this.signaling = null, this.streamName = e, this.autoReconnect = n, this.reconnectionInterval = 1e3, this.alreadyDisconnected = !1, this.firstReconnection = !0, this.tokenGenerator = t, this.options = null
		}
		stop() {
			var e;
			qr.info("Stopping"), this.webRTCPeer.closeRTCPeer(), null === (e = this.signaling) || void 0 === e || e.close(), this.signaling = null, this.webRTCPeer = new Ar
		}
		isActive() {
			const e = this.webRTCPeer.getRTCPeerStatus();
			return qr.info("Broadcast status: ", e || "not_established"), "connected" === e
		}
		setReconnect() {
			this.autoReconnect && (this.signaling.on(wr, (() => {
				!this.firstReconnection && this.alreadyDisconnected || (this.firstReconnection = !1, this.reconnect())
			})), this.webRTCPeer.on(Tr, (e => {
				("failed" === e || "disconnected" === e && this.alreadyDisconnected) && this.firstReconnection ? (this.firstReconnection = !1, this.reconnect()) : "disconnected" === e ? (this.alreadyDisconnected = !0, setTimeout((() => this.reconnect()), 1500)) : this.alreadyDisconnected = !1
			})))
		}
		reconnect() {
			var e = this;
			return g((function*() {
				try {
					...
					e.reconnectionInterval = Xr(e.reconnectionInterval), qr.error(`Reconnection failed, retrying in ${e.reconnectionInterval}ms. Error was: `, t), e.emit("reconnect", {
						timeout: e.reconnectionInterval,
						error: t
	...
	class Qr extends xe {
		...
		subscribe(e) {
			Zr.info("Subscribing to event topic"), Zr.debug("Topic request value: ", e), e = JSON.stringify(e) + Kr, this.webSocket.onmessage = e => {
				var t;
				var r, n = w(null === (t = e.data) || void 0 === t ? void 0 : t.split(Kr));
				try {
					for (n.s(); !(r = n.n()).done;) {
						const e = r.value;
						if (e) {
		...
		initializeHandshake() {
			...
			return g((function*() {
				var t, r;
				if ((null === (t = e.webSocket) || void 0 === t ? void 0 : t.readyState) !== WebSocket.CONNECTING && (null === (r = e.webSocket) || void 0 === r ? void 0 : r.readyState) !== WebSocket.OPEN) return new Promise(((t, r) => {
					Zr.info("Starting events WebSocket handshake."), e.webSocket = new WebSocket("wss://streamevents.millicast.com/ws"), e.webSocket.onopen = () => {
		...
		parseSignalRMessage(e) {
			return e = e.endsWith(Kr) ? e.slice(0, -1) : e, JSON.parse(e)
		}
		close() {
			this.webSocket && (this.webSocket.close(), this.webSocket.onclose = () => {
				Zr.info("Events WebSocket closed"), this.webSocket = null
			})
		}
	}
	const en = L.get("StreamEvents"),
		tn = 1,
		rn = 3;
	let nn = 0;
	const sn = "You need to initialize stream event with StreamEvents.init()";
	class on {
		constructor() {
		...
		onUserCount(e, t, r) {
			if (!this.eventSubscriber) throw en.error(sn), new Error(sn);
			en.info(`Starting user count. AccountId: ${e}, streamName: ${t}`);
			const n = `${e}/${t}`,
				i = nn++,
				s = {
					arguments: [
			...
			this.eventSubscriber.subscribe(s), this.eventSubscriber.on("message", (e => {
				an(n, i, e, r)
			}))
		}
		stop() {
		...
		switch (r.type) {
					...
					try {
						for (s.s(); !(i = s.n()).done;) {
							...
							if (r === e) {
								...
								en.debug("User count changed: ", e), n(e)
							}
						}
					} catch (e) {
						s.e(e)
			...
			case rn:
				if (r.error && r.invocationId === t) {
					...
					en.error("User count error: ", r.error), n(t)
				}
		}
	};
	...
	var fn = function() {
		function e(t) {
			s(this, e), this.mediaStream = null, this.constraints = {
				audio: {
					echoCancellation: !1,
					channelCount: {
						ideal: 2
		...
		return a(e, [{
			...
			value: function(e) {
				...
				if (!e) return t;
				if (this.mediaStream) {
					var r, n = dn(this.mediaStream.getTracks());
					try {
						for (n.s(); !(r = n.n()).done;) {
							var i = r.value;
							if (i.kind === e) {
					...
					for (;;) switch (e.prev = e.next) {
						...
						case 2:
							return e.prev = 2, t = {
								...
								videoinput: [],
								audiooutput: []
							}, e.next = 6, navigator.mediaDevices.enumerateDevices();
						case 6:
							r = e.sent, i = dn(r);
							try {
			...
			key: "changeSource",
			value: (r = t(n.mark((function e(t, r) {
				return n.wrap((function(e) {
					for (;;) switch (e.prev = e.next) {
						case 0:
							if (t) {
						...
						case 2:
							return this.constraints[r] = un(un({}, this.constraints[r]), {}, {
								deviceId: {
									exact: t
								}
							}), e.next = 5, this.getMedia();
						case 5:
							return e.abrupt("return", e.sent);
						case 6:
						case "end":
	...
	var gn = function(e) {
		...
		function f(e, t, r) {
			var n;
			return s(this, f), (n = l.call(this, e.streamName, t, r)).mediaManager = new fn(e), n
		}
		return a(f, [{
			key: "constraints",
			get: function() {
					...
					for (;;) switch (e.prev = e.next) {
						case 0:
							return t = r.length > 0 && void 0 !== r[0] ? r[0] : {
								...
								disableVideo: !1,
								disableAudio: !1
							}, e.next = 3, u(c(f.prototype), "connect", this).call(this, hn(hn({}, t), {}, {
			...
			value: function(e, t) {
				var r = this;
				return "audio" === e ? new Promise((function(e, n) {
					r.mediaManager.changeAudio(t).then((function(t) {
				...
				})) : "video" === e ? new Promise((function(e, n) {
					r.mediaManager.changeVideo(t).then((function(t) {
		...
		connect(e = Jr) {
			var t = this;
			return g((function*() {
				if (Yr.debug("Broadcast option values: ", e), t.options = h(h({}, Jr), e), !t.options.mediaStream) throw Yr.error("Error while broadcasting. MediaStream required"), new Error("MediaStream required");
				if (t.isActive()) throw Yr.warn("Broadcast currently working"), new Error("Broadcast currently working");
				let r;
				try {
					r = yield t.tokenGenerator()
				} catch (e) {
					throw Yr.error("Error generating token."), e
				}
				if (!r) throw Yr.error("Error while broadcasting. Publisher data required"), new Error("Publisher data required");
				t.signaling = new xr({
					streamName: t.streamName,
					url: `${r.urls[0]}?token=${r.jwt}`
				}), yield t.webRTCPeer.createRTCPeer(t.options.peerConfig), De(t.webRTCPeer, t, [Tr]);
				const n = yield t.webRTCPeer.getRTCLocalSDP(t.options);
				let i = yield t.signaling.publish(n, t.options.codec, t.options.record);
				!t.options.disableVideo && t.options.bandwidth > 0 && (i = t.webRTCPeer.updateBandwidthRestriction(i, t.options.bandwidth)), yield t.webRTCPeer.setRTCRemoteSDP(i), t.setReconnect(), Yr.info("Broadcasting to streamName: ", t.streamName)
			}))()
		}
		reconnect() {
			var e, t;
	...
	window.Logger = L;
	var vn, yn = process.env.MILLICAST_STREAM_NAME,
		wn = process.env.MILLICAST_ACCOUNT_ID,
		bn = process.env.MILLICAST_PUBLISH_TOKEN,
		Sn = !1,
		Cn = !1,
		En = !1;
	document.addEventListener("DOMContentLoaded", (vn = t(n.mark((function e(r) {
		var i, s, o, a, c, u, d, l, f, p, h, m, g, v, y, w, b, S, C, E, x, k, I, T, R, A, P, L, O, B, M, N, D, j, U;
		return n.wrap((function(e) {
			for (;;) switch (e.prev = e.next) {
				case 0:
					return U = function() {
						...
						if (r.type = "text", r.readonly = !0, r.value = t, r.style.position = "fixed", r.style.left = "-9999px", document.body.appendChild(r), /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) {
						...
						var t = "https://viewer.techdemos.wowza.com/v2?streamId=".concat(wn, "/").concat(yn);
						o.removeChild(o.firstChild), o.innerHTML = t, w.classList.remove("d-none")
					}, B = function(e) {
						Sn ? (M(), c.classList.remove("hidden"), a.classList.add("hidden"), d.disabled = !0, x.disabled = !1, b || D(), showGuide && (showGuide("guide1", !1), showGuide("guide2", !0))) : (c.classList.add("hidden"), a.classList.remove("hidden"), d.disabled = !1)
					}, O = function(e) {
						"mic" !== e && e || (micListBtn.innerHTML = "<p>" + j(E.activeAudio.label) + '</p><span class="boxCover"></span>'), "cam" !== e && e || (camListBtn.innerHTML = "<p>" + j(E.activeVideo.label) + '</p><span class="boxCover"></span>')
					}, L = function(e) {
						...
						return (P = t(n.mark((function e() {
							var r, a;
							return n.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									case 0:
										return x.innerHTML = 0 === k ? "Maximum Bitrate" : "".concat(k, " kbps"), 0 !== k && T(), v.forEach((function(e) {
											e.classList.add("btn"), e.addEventListener("click", T)
										})), r = {
											channelCount: {
												ideal: 2
											},
											echoCancellation: !1
										}, console.log("constraints audio:", r, " disableAudio:", r), E.mediaManager.constraints = {
											audio: r,
											video: {
												width: {
													min: 640,
										...
										}, e.prev = 8, e.next = 11, E.getMediaStream();
									case 11:
									...
									case 21:
										d.addEventListener("click", function() {
											...
											if (E.muteMedia("video", !Cn)) {
												Cn = !Cn;
												var t = document.querySelector("#camOnIcon");
												Cn ? t.classList.add("fa-video-slash") : t.classList.remove("fa-video-slash")
											}
											...
											if (E.muteMedia("audio", !En)) {
												En = !En;
												var t = document.querySelector("#micOnIcon");
												En ? t.classList.add("fa-microphone-slash") : t.classList.remove("fa-microphone-slash")
											}
						...
						Sn = !1, console.log("Failed to set session description: " + e.toString())
					}, $(".privy-popup-container, .privy-popup-content-wrap").click((function(e) {
						return !1
					})), i = document.querySelector("video"), (s = window.mobilecheck = (r = void 0, _ = void 0, _ = !1, r = navigator.userAgent || navigator.vendor || window.opera, (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(r) || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(r.substr(0, 4))) && (_ = !0), _)) || i.setAttribute("class", "vidWinBrowser"), o = document.getElementById("viewerURL"), a = document.getElementById("readyBadge"), c = document.getElementById("liveBadge"), u = document.getElementById("userCount"), d = document.getElementById("publishBtn"), l = document.getElementById("camList"), f = document.getElementById("camMuteBtn"), p = document.getElementById("micList"), h = document.getElementById("micMuteBtn"), m = document.getElementById("copyBtn"), document.getElementById("ctrlUI"), document.getElementById("shareView"), g = document.getElementById("signUpBtn"), v = document.querySelectorAll("#bandwidthMenu>.dropdown-item"), y = document.getElementById("publishSection"), w = document.getElementById("shareSection"), S = 3e5, e.next = 32, on.init();
				case 32:
					return e.sent.onUserCount(wn, yn, (function(e) {
						var t = e.count;
						u.innerHTML = t
					})), C = function() {
						return Hr.getPublisher(bn, yn)
					}, e.next = 40, gn.build({
						streamName: yn
					}, C, !0);
				case 40:
					E = e.sent, x = document.querySelector("#bandwidthMenuButton"), k = 0, I = function() {
						var e = t(n.mark((function e() {
							return n.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									case 0:
										return e.prev = 0, e.next = 3, E.connect({
											bandwidth: k,
											codec: "h264"
										});
									case 3:
										...
										break;
									case 7:
										e.prev = 7, e.t0 = e.catch(0), console.log(e.t0), Sn = !1, B(), R(e.t0);
									case 13:
									case "end":
										return e.stop()
								}
