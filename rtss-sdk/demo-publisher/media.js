class Media {
   ...
   * @example const devices = await wowzartsMedia.getDevices;
   ...
   * @example const videoInput = wowzartsMedia.videoInput;
   ...
   * @example const audioInput = wowzartsMedia.audioInput;
   * @returns {MediaStreamTrack}
   */
  ...
  /**
   * Get User Media.
   * @example const media = await WowzaRTSMedia.getMedia();
   * @returns {MediaStream}
   */
   ...
   * @example const media = await wowzartsMedia.changeVideo(id);
   ...
   * @example const media = await wowzartsMedia.changeAudio(id);
